...
<template>
  <div class="sans-serif pt-6 grid gap-6 sm:gap-8 xl:gap-10">
    <Prose>
      <h2>{{ item.title }}</h2>
    </Prose>
    <Prose v-html="item.content" class="max-w-none prose-img:m-0 prose-img:sm:m-0 prose-img:md:m-0 prose-img:lg:m-0 prose-img:xl:m-0" />
    <div
